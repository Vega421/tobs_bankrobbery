...
RegisterServerEvent("tobsbank:toggleDoor")
AddEventHandler("tobsbank:toggleDoor", function(key, state)
    ...
    TriggerClientEvent("tobsbank:toggleDoor", -1, key, state)
end)

RegisterServerEvent("tobsbank:toggleVault")
AddEventHandler("tobsbank:toggleVault", function(key, state)
    ...
    TriggerClientEvent("tobsbank:toggleVault", -1, key, state)
end)
...
RegisterServerEvent("tobsbank:updateVaultState")
AddEventHandler("tobsbank:updateVaultState", function(key, state)
    ...
    TriggerClientEvent("tobsbank:vaultState", -1, key, state)
end)
